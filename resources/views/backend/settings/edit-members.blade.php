    ...
    <main id="main" class="main">
        <div class="container mt-4 mb-3 " id="blog-div">
            <div class="row align-items-center">
                <h1 class="general-settings-heading">Edit Member</h1>
                ...
                <div class="">
                    <button type="submit" class="btn btn-primary ms-5 mt-2">Update</button>
                </div>
                <br>
            </form>
            ...
            {{--  ----  --}}
                    ...
                    <form id="form2" class="row g-3 ms-5" method="POST" action="{{ route('update-members', ['id' => $manageMembers->id]) }}"
...
@method('PUT')
                        ...
                        <div class="col-8">
                            ...
                            <input type="text" name="name" class="form-control" id="inputNanme4" value="{{ $manageMembers->name }}">
                        </div>
                        ...
                        <div class="col-8">
                            ...
                            <input type="text" name="designation" class="form-control" id="inputNanme4" value="{{ $manageMembers->designation }}">
                        </div>
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-primary ms-5 mt-2">Update Member</button>
                        </div>
                        <br>
                    </form>
            </div>
