            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="banner-img-3">
                        <img src="{{ asset('storage/'.$generalSetting->banner_image) }}" alt="Banner Images">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="service-details.html">
                            <img src="{{ asset('storage/'.$service->icon) }}" alt="Images">
                        </a>
                        <a href="service-details.html">
                            <h3>{{ $service->title }}</h3>
                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-price">
                                <span>Basic Plan</span>
                                <div class="single-price-title">
                                    <h2><sup>$</sup>{{ $yearlyBasic->price }}<sub>/month</sub></h2>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-price current">
                                <span>Standard Plan</span>
                                <div class="single-price-title">
                                    <h2><sup>$</sup>{{ $yearlyStandard->price }}<sub>/month</sub></h2>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
                            <div class="single-price">
                                <span>Premium Plan</span>
                                <div class="single-price-title">
                                    <h2><sup>$</sup>{{ $yearlyPremium->price }}<sub>/month</sub></h2>
                                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-img">
                            <a href="portfolio.html">
                                <img src="{{ ('storage/'.$portfolio->image) }}" alt="Portfolio Images">
                            </a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="member-card">
                        <div class="member-img">
                            <a href="members.html">
                                <img src="{{ ('storage/'.$member->image) }}" alt="Member Images">
                            </a>
            ...
            <div class="client-slider owl-carousel owl-theme">
                ...
                <div class="client-item">
                    <div class="client-item-img">
                        <img src="{{ asset('storage/'.$feedback->image) }}" alt="Testimonial Images">
                    </div>
                    <h3>{{ $feedback->name }}</h3>
                    <p>
                        {{ $feedback->feedback }}
                    ...
                    <div class="blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html">
                                <img src="{{ ('storage/'.$blog->photo) }}" alt="Blog Images">
                            </a>
                        </div>
